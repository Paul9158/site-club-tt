...
export default async function Home() {
  ...
  const [upcoming, past, competitions, homeBlocks] = await Promise.all([
    settings.show_upcoming_matches
      ? getUpcomingMatches(4)
      : Promise.resolve<Match[]>([]),
    settings.show_past_matches
      ? getPastMatches(3)
      : Promise.resolve<Match[]>([]),
    settings.show_upcoming_competitions
      ? getCompetitions()
  ...
  return (
    <div>
      ...
      {settings.show_upcoming_competitions && upcomingCompetitions.length > 0 && (
